...
public class OvusculeSnake2DKeeper {
    ...
    private static final double SQRT_TINY = sqrt((double)Float.intBitsToFloat(0x33FFFFFF));
    private static final double TINY = (double)Float.intBitsToFloat(0x33FFFFFF);
