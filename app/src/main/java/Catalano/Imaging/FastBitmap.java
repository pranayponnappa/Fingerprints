...
public class FastBitmap {
    ...
    public FastBitmap(FastBitmap fastBitmap){
        this.buffImg = fastBitmap.toBufferedImage();
     ...
     */
    public FastBitmap(Bitmap bufferedImage) {
    ...
    public FastBitmap(String pathname){
     ...
     Bitmap  yourSelectedImage = BitmapFactory.decodeFile(pathname);
     this.bufferedImage = img.setImageBitmap(yourSelectedImage);
*/
            ...
            //this.bufferedImage = BitmapFactory.decodeResource(context.getResources(),
